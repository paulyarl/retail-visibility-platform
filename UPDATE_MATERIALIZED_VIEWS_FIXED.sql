-- Update Materialized Views to Include Store Rating System - FIXED VERSION
-- This script updates all materialized views to join with the new store_rating_summary table
-- Uses correct column names from your actual database
...
SELECT 
    ...
    dcl.city,
    dcl.state,
    dcl.zip_code,  -- Changed from postal_code
    dcl.phone,
    dcl.email,
    dcl.website,
    dcl.latitude,
