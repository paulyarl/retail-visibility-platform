...
- sub_categories: 2-6 short specialization labels within this category (e.g. "West African grocery", "Afro-Caribbean grocery", "pan-African grocery") — emit chip-length names, NOT descriptive phrases like "full-line market with a butcher counter". Used for drill-down on the category page. Return an empty array if the category has no meaningful sub-specializations.
...
- A category label may appear in only ONE of super_categories, secondary_categories, adjacent_categories — never repeat a label across these fields (e.g. do not put the parent shelf in secondary_categories).
...
- context.category_profile: STRUCTURAL characteristics of the category as a business type — the same description must hold for ANY US market. NEVER name this campaign's city, state, streets, neighborhoods, or any business in it (that is what category_summary and category_notes are for). Fields: { business_model (qualitative: e.g. "typically independent, family-owned, single-location"), typical_products (qualitative: what they sell), customer_base (qualitative: who they serve), online_presence_pattern (qualitative: e.g. "varies widely — many rely on Google/Yelp only"), competitive_landscape (qualitative: e.g. "sparse in most US cities, concentrated in metro areas with large diaspora"), typical_scale (qualitative: e.g. "single-location, small team") }. Use qualitative descriptors, NOT specific revenue figures or employee counts.
...
- sub_categories: 2-6 short specialization labels within this category (e.g. "West African grocery", "Afro-Caribbean grocery") — chip-length names, NOT descriptive phrases. Return an empty array if none are meaningful.
...
- A category label may appear in only ONE of super_categories, secondary_categories, adjacent_categories — never repeat a label across these fields.
...
- context.category_profile: STRUCTURAL characteristics of the category as a business type — the same description must hold for ANY US market. NEVER name the city, state, streets, neighborhoods, or any business in it (that is what category_summary and category_notes are for). Fields: { business_model, typical_products, customer_base, online_presence_pattern, competitive_landscape, typical_scale } — all qualitative descriptors, NOT specific revenue figures or employee counts.
