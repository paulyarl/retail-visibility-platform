...
// Core business routes - temporarily disabled for isolation
...
export function mountCoreRoutes(app: Express) {
  ...
  console.log('⚠️ Core routes disabled for debugging');
  ...
  console.log('✅ Core business routes mounted (disabled)');
}
