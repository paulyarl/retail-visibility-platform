...
router.get('/summary', async (req: Request, res: Response) => {
  try {
    ...
    console.error('Error fetching public tenant review summary:', error);
    res.status(500).json({
      success: false,
...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    console.error('Error fetching public tenant reviews:', error);
    res.status(500).json({
      success: false,
...
router.get('/approved', async (req: Request, res: Response) => {
  try {
    ...
    console.error('Error fetching approved public tenant reviews:', error);
    res.status(500).json({
      success: false,
