...
const CONSTRAINT_METADATA: ConstraintMetadata = {
  capabilities: [
    ...
    },
    {
      ...
      fields: [
        { field: 'enabled', label: 'Enabled', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_create_coupons', label: 'Can Create Coupons', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_percent_off', label: 'Can Use Percent Off', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_fixed_amount', label: 'Can Use Fixed Amount', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_free_shipping', label: 'Can Use Free Shipping', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_bogo', label: 'Can Use BOGO', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_target_products', label: 'Can Target Products', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_set_limits', label: 'Can Set Limits', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_view_analytics', label: 'Can View Analytics', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_qr_sharing', label: 'Can Use QR Sharing', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'can_use_spotlight', label: 'Can Use Spotlight', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
        { field: 'allowed_discount_types', label: 'Allowed Discount Types', value_type: 'array', operators: ARRAY_OPS, values: ['percent_off', 'fixed_amount', 'free_shipping', 'bogo'] },
        { field: 'is_flexible', label: 'Is Flexible', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
      ],
    },
  ],
