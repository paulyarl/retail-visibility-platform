  ...
  capabilities: [
    ...
    },
    {
      ...
      fields: [
        ...
        { field: 'payment_type', label: 'Payment Type', value_type: 'string', operators: STRING_OPS, values: ['full', 'deposit', 'both', 'none'] },
        { field: 'effective_payment_type', label: 'Effective Payment Type', value_type: 'string', operators: STRING_OPS, values: ['full', 'deposit', 'both', 'none'] },
        { field: 'is_flexible', label: 'Is Flexible', value_type: 'boolean', operators: BOOL_OPS, values: ['true', 'false'] },
      ],
    },
    {
