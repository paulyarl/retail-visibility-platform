    ...
    const transformedBuckets = Object.fromEntries(
      Object.entries(buckets).map(([bucketType, products]) => [
        ...
        products.map((product: any) => ({
          ...
          price: typeof product.list_price_cents === 'number' ? product.list_price_cents / 100 : (typeof product.current_price_cents === 'number' ? product.current_price_cents / 100 : 0),
          priceCents: product.list_price_cents || product.current_price_cents,
