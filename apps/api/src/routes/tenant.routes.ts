...
import storefrontHoursSettingsRoutes from './storefront-hours-settings';
import storefrontLayoutsSettingsRoutes from './storefront-layouts-settings';
import storefrontMapsSettingsRoutes from './storefront-maps-settings';
...
router.use('/', storefrontHoursSettingsRoutes);
router.use('/', storefrontLayoutsSettingsRoutes);
router.use('/', storefrontMapsSettingsRoutes);
