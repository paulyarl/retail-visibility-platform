...
// Performance: <10ms
// ============================================================================
router.get('/stores/featured', asyncErrorWrapper((req, res) => directoryController.getFeaturedStores(req, res)));
...
// ============================================================================
router.get('/search', asyncErrorWrapper((req, res) => directoryController.search(req, res)));
