  ...
  return {
    ...
    effective: {
      ...
      storefront_options: {
        ...
        can_use_layout_editorial: false,
        can_use_layout_immersive: false,
        gallery_magazine_enabled: false,
        can_use_magazine_gallery: false,
        merchant_preferences: {},
      },
      storefront_qr: {
        enabled: false,
      ...
      storefront_gallery: {
        ...
        gallery_display_mode: 'carousel' as const,
        gallery_carousel_enabled: false,
        gallery_magazine_enabled: false,
        can_use_magazine_gallery: false,
      ...
      wholesale_matching: {
        enabled: false,
        tier: 'none' as const,
        can_check_supplier_match: false,
        can_search_faire: false,
        can_build_affiliate_link: false,
        can_view_brand_partners: false,
        is_flexible: false,
      },
      platform_services: {
        enabled: false,
      ...
      coupon_options: {
        ...
        can_use_percent_off: false,
        can_use_fixed_amount: false,
        can_use_free_shipping: false,
        can_use_bogo: false,
        can_target_products: false,
        can_set_limits: false,
        can_view_analytics: false,
        can_use_qr_sharing: false,
      ...
      marketing_ops: {
        enabled: false,
        can_use_prompt_execution: false,
        can_use_filter_review: false,
        can_use_batch_execution: false,
        can_use_revenue_tracking: false,
        is_flexible: false,
      },
    },
