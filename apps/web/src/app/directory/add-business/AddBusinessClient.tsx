...
export default function AddBusinessClient({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.businessName.trim() || !form.address.trim() || !form.city.trim() || !form.state.trim() || !form.ownerName.trim() || !form.ownerEmail.trim()) {
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 md:p-8">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mb-6">
            List your business in the directory. Our team will review your submission before it goes live.
          </p>
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="border-t border-neutral-200 dark:border-neutral-700 pt-5">
                <h3 className="text-sm font-medium text-neutral-900 dark:text-white mb-4">Owner Contact</h3>
              ...
              <Textarea
                ...
                placeholder="Hours, specialties, social links, or anything that helps verify the business..."
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400 text-center">
                Submissions are reviewed before being published. If you just want to tip us off about another business,{' '}
                <Link href="/directory/suggest" className="underline text-blue-600 dark:text-blue-400">
                  suggest a business
                </Link>
                {' '}instead.
              </p>
