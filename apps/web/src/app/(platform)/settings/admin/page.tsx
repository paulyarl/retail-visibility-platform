...
export default function AdminDashboardPage() {
  ...
  const adminGroups: AdminGroup[] = [
    ...
    },
    {
      ...
      description: 'Local business campaign pipeline, prompt management, and revenue tracking',
      sections: [
        {
        ...
        },
        {
          ...
          description: 'Triage queued business prospects awaiting campaign assignment',
          href: '/settings/admin/marketing-ops/queue',
          icon: (
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-3.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 009.586 13H4" />
            </svg>
          ),
          color: 'bg-orange-400',
          stats: 'Queued prospects',
          badge: 'NEW',
        },
        {
          title: 'Campaign Tracker',
          description: 'Manage prospect campaigns with Kanban board and stage transitions',
          ...
          color: 'bg-orange-600',
          stats: 'Pipeline tracker',
          badge: 'NEW',
        },
        {
          title: 'Recovery',
          description: 'Manage dispute intake, profile repair, and recovery workflows',
          ...
          color: 'bg-amber-500',
          stats: 'Intake & recovery',
          badge: 'NEW',
        },
        {
          title: 'Playbooks',
          description: 'Build and manage outreach playbooks with checklist templates',
          ...
          color: 'bg-violet-500',
          stats: 'Outreach playbooks',
          badge: 'NEW',
        },
        {
          title: 'Prompt Library',
          description: 'Manage seek, fulfill, and filter prompt templates with variable injection',
        ...
        },
        {
          ...
          description: 'Craft and review outreach opener messages for prospect campaigns',
          ...
          color: 'bg-rose-500',
          stats: 'Opener workspace',
          badge: 'NEW',
        },
        {
          title: 'Follow-Ups',
          description: 'Track and send outreach follow-ups across active campaigns',
          href: '/settings/admin/marketing-ops/follow-ups',
          icon: (
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
