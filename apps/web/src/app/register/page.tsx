 ...
 * 
 * This page redirects users to Auth0's hosted signup page.
 * Auth0 handles account creation securely with password policies, etc.
 * After first login, users will go through an onboarding wizard.
 */
