...
const tiers = [
  {
    ...
    price: '$29',
    period: '/month',
    description: 'Visibility for small retailers (1–3 locations)',
    features: [
      'Up to 3 locations',
      'Up to 500 SKUs per location',
      'Google Shopping feeds & Merchant Center sync',
      'Complete storefront with catalog & search',
      'Directory listing',
  ...
  },
  {
    ...
    price: '$99',
    period: '/month',
    description: 'Connected & growing retailers (POS + analytics)',
    features: [
      'Up to 10 locations',
  ...
  },
  {
    ...
    cta: 'Contact Sales',
    popular: false,
    badge: 'FULL CONNECTOR',
  },
  {
    name: 'Organization',
    price: 'Custom',
    period: '',
    description: 'Chains & franchises with 25+ locations',
    features: [
      'Unlimited locations',
      'Unlimited SKUs (within technical limits)',
      'Multiple propagation types across all stores',
      'Hero location & brand asset distribution',
      'Org-level analytics and billing',
