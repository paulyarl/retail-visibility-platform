  ...
  return mounted ? (
    <div className="container mx-auto p-6">
      ...
      <div className="mt-6 space-y-6">
        ...
        {/* Summary Stats - Enhanced Stats Ring Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Tenant Capacity Card - Enhanced */}
          <Card withBorder padding="xl" radius="md" className="relative">
            <Card.Section className="p-6">
              <Group justify="space-between" mb="md">
                ...
                <MantineBadge 
                  color={stats.totalTenants > 800 ? 'red' : stats.totalTenants > 500 ? 'orange' : 'green'}
                  variant="light"
                >
              ...
              <Group align="flex-end" mb="md">
                ...
                <RingProgress
                  ...
                  sections={[
                    {
                      value: Math.min((stats.totalTenants / 1000) * 100, 100),
                      color: stats.totalTenants > 800 ? 'red' : stats.totalTenants > 500 ? 'orange' : 'green'
                    }
                  ]}
                  label={
                    <Text ta="center" fz="xs" fw={600}>
                      {Math.round((stats.totalTenants / 1000) * 100)}%
                    </Text>
                  }
                />
              </Group>
              ...
              <Group justify="space-between">
                <Text size="xs" c="dimmed">
                  {1000 - stats.totalTenants} slots available
                </Text>
                <Text size="xs" c="dimmed">
          ...
          {/* Search Efficiency Card - Enhanced */}
          <Card withBorder padding="xl" radius="md" className="relative">
            <Card.Section className="p-6">
              <Group justify="space-between" mb="md">
                <div>
              ...
              <Group align="flex-end" mb="md">
                ...
                <RingProgress
                  ...
                  sections={[
                    {
                      value: stats.totalTenants > 0 ? (stats.filteredCount / stats.totalTenants) * 100 : 0,
                      color: 'blue'
                    }
                  ]}
                  label={
                    <Text ta="center" fz="xs" fw={600}>
                      {stats.totalTenants > 0 ? Math.round((stats.filteredCount / stats.totalTenants) * 100) : 0}%
                    </Text>
                  }
                />
              </Group>
              ...
              <Group justify="space-between">
                <Text size="xs" c="dimmed">
                  {searchQuery ? 'Active search' : 'No filters'}
                </Text>
                <Text size="xs" c="dimmed">
                  {stats.totalTenants - stats.filteredCount} hidden
                </Text>
              </Group>
            </Card.Section>
          </Card>

          {/* Tier Distribution Card - Enhanced */}
          <Card withBorder padding="xl" radius="md" className="relative">
            <Card.Section className="p-6">
              <Group justify="space-between" mb="md">
                <div>
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {selectedTierFilter === 'all' 
                    ? 'All Tenants' 
                    : `${tiers.find((t: { tierKey: string; displayName: string }) => t.tierKey === selectedTierFilter)?.displayName} Tenants`}
                </h3>
