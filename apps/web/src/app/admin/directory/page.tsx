...
async function getDirectoryStats() {
  // This would normally fetch from API, but we'll use client-side hook in a client component
  return null;
}
...
'use client';
function DirectoryOverviewClient() {
  const { useAdminDirectoryStats } = require('@/hooks/admin/useAdminDirectoryStats');
