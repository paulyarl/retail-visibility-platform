...
export const BUSINESS_TYPES: BusinessType[] = [
  ...
  { id: 'service_business', name: 'Service Business', icon: '🛎️', description: 'Consulting, repairs, appointments, subscriptions', defaultCategoryCount: 4, defaultProductCount: 16 },
