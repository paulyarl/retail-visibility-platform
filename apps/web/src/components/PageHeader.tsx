        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center h-9 w-9 rounded-md border border-neutral-300 hover:bg-neutral-50 transition-colors"
              title="Settings"
            >
...
export const Icons = {
  ...
  Bell: (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.711.4 3.27.99 4.641 1.713a23.848 23.848 0 005.454 1.31M18 9a6 6 0 01-12 0v.75a8.967 8.967 0 002.312 6.022M17 3a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  ),
  Appearance: (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
