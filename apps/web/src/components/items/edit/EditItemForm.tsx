...
export default function EditItemForm({
  ...
  const tabProps = {
    values: {
      ...
      enhancedDescription: form.enhancedDescription, contentBlocks: form.contentBlocks,
      features: form.features, specifications: form.specifications, status: form.status,
    ...
    setters: {
      ...
      setEnhancedDescription: form.setEnhancedDescription, setContentBlocks: form.setContentBlocks,
      setFeatures: form.setFeatures, setSpecifications: form.setSpecifications, setStatus: form.setStatus,
