...
import { IconBuilding, IconPlus, IconRefresh, IconArrowLeft, IconPackages, IconEdit, IconUser, IconEye, IconStatusChange, IconTrash, IconCheck, IconLayoutGrid, IconList, IconUsers } from "@tabler/icons-react";
              ...
              <Card withBorder p="md">
                <Flex justify="space-between" align="center">
                  ...
                  <Box w={48} h={48} bg="cyan.6" style={{ borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <svg style={{ width: 24, height: 24 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" color="#9ca3af">
