                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {tenant.organization && (
                      <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs bg-blue-100 text-blue-800 border border-blue-300 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-700">
                        <svg className="w-6 h-6" fill="none" viewBox="0 0 48 48" stroke="currentColor">
        ...
        {!editing && (
          <div className="flex flex-wrap items-center gap-2 pt-3 border-t border-neutral-100 mt-3">
            {/* Quick Status Change - Prominent placement */}
             ...
             {canRename && (
              <Button size="sm" variant="secondary" onClick={() => setEditing(true)} title="Click to rename the location's name">
                <svg className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Button size="sm" variant="secondary" onClick={() => window.open(`/tenant/${tenant.id}`, '_blank')} title="Click to preview the inventory storefront website">
              <svg className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
