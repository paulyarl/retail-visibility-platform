  ...
  const legacySettingsGroups = [
    {
      ...
      cards: [
        ...
        },
        {
          ...
          description: 'Create and manage discount coupons, track redemptions, and spotlight featured offers',
          icon: (
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            </svg>
          ),
          href: `/t/${tenantId}/settings/coupon-options`,
          color: 'bg-green-600',
          badge: 'NEW',
          accessOptions: { roles: ['admin', 'support'] },
          capabilityKey: 'couponOptions',
        },
        {
    ...
    },
    {
      ...
      cards: [
        ...
        {
          title: 'QR Codes',
          description: 'Customize QR code styles, colors, gradients, and resolution for your storefront',
          icon: (
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
          title: 'Storefront Maps',
          description: 'Configure interactive maps, map display, and location display on your storefront',
          icon: (
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
            </svg>
          ),
          href: `/t/${tenantId}/settings/storefront-maps`,
          color: 'bg-emerald-500',
          badge: 'NEW',
          accessOptions: { roles: ['admin', 'support'] },
          capabilityKey: 'storefrontMaps',
        },
        {
