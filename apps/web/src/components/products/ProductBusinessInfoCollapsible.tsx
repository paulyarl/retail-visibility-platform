...
export default function ProductBusinessInfoCollapsible({
    ...
    const infoCount = [
        ...
        metadata?.address && showLocation && showsMap // for map
    ...
    return (
        <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-purple-50">
            ...
            {/* Collapsible Content */}
            {isExpanded && (
                <CardContent className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-orange-50">
                    <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {hoursStatus && showHours && (
                                <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-neutral-900 dark:text-white">Store Sign</p>
                            ...
                            <div>
                                ...
                                {(metadata?.social_links as any)?.facebook || (metadata?.socialLinks as any)?.facebook ? (
                                    <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                href={(metadata?.social_links as any)?.facebook || (metadata?.socialLinks as any)?.facebook}
                                                target="_blank"
                                                ...
                                                title="Facebook"
                                            >
                                                <svg className="h-12 w-12" fill="currentColor" viewBox="0 0 30 30">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                                <p className="text-sm font-medium text-neutral-900 dark:text-white">View and like us</p>
                                            </a>
                                ...
                                {(metadata?.social_links as any)?.instagram || (metadata?.socialLinks as any)?.instagram ? (
                                    <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                href={(metadata?.social_links as any)?.instagram || (metadata?.socialLinks as any)?.instagram}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            ...
                                            >
                                                ...
                                                <p className="text-sm font-medium text-neutral-900 dark:text-white">View and share with us</p>
                                            </a>
                                ...
                                {(metadata?.social_links as any)?.twitter || (metadata?.socialLinks as any)?.twitter ? (
                                    ...
                                    <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                href={(metadata?.social_links as any)?.twitter || (metadata?.socialLinks as any)?.twitter}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                ...
                                {(metadata?.social_links as any)?.linkedin || (metadata?.socialLinks as any)?.linkedin ? (
                                    ...
                                    <div className="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-neutral-900 dark:text-white">View and link with us</p>

                                            <a
                                                href={(metadata?.social_links as any)?.linkedin || (metadata?.socialLinks as any)?.linkedin}
                                                target="_blank"
                                                rel="noopener noreferrer"
                        ...
                        {/* Interactive Map */}
                        {metadata?.address && showLocation && showsMap && (
                            <div>
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    {storeStatus && (
                                        <span className={`flex items-center gap-2 text-sm px-3 py-1.5 rounded-full ${
                                            ...
                                            <span className={`inline-block w-2 h-2 rounded-full ${storeStatus.label.includes('(') && storeStatus.label.includes(')')
                                                    ? 'bg-amber-500'
