-- Store Reviews and Ratings System - Fixed for actual database column types
...
-- 6. Location-Aware Rating Query Functions
...
-- 7. Initialize rating summaries for existing stores
...
WHERE dcl.tenant_exists = true
    ...
    AND dcl.tenant_id NOT IN (SELECT tenant_id FROM store_rating_summary)
